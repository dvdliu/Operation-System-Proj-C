...
public:
    ...
    // Newly added variables and functions
    thread_ptr executing_thread;               // An executing thread on a CPU
    thread_ptr waiting_thread;
    static queue<thread_ptr> ready_threads;    // queue of ready threads, managed by the cpu class
    static queue<thread_ptr> finished_threads;
    static queue<cpu *> suspended_cpus;   // set of suspended cpus
