...
{
    std::cout << "[Uniprocessor] Running computer contention test 2.0 with 100 threads and 10 shared resources." << std::endl;
    ...
    std::cout << "[Uniprocessor] Computer contention test 2.0 completed." << std::endl;
}
