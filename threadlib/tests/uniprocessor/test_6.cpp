...
void test_func3(uintptr_t)
{
    ...
    std::cout << "[Uniprocessor] Test 6: Thread 3 finished running" << std::endl;
    mutex1.unlock();
    mutex2.unlock();
}
...
void test_func2(uintptr_t)
{
    ...
    std::cout << "[Uniprocessor] Test 6: Thread 2 finished running" << std::endl;
    mutex1.unlock();
...
void test_func1(uintptr_t)
{
    ...
    std::cout << "[Uniprocessor] Test 6: Thread 1 finished running" << std::endl;
    mutex2.unlock();
    mutex1.unlock();
...
{
    std::cout << "[Uniprocessor] Test 6: Running test with 3 threads." << std::endl;
    ...
    std::cout << "[Uniprocessor] Test 6: All threads finished." << std::endl;
}
