...
void test_thread1(uintptr_t){
    ...
    std::cout << "[Uniprocessor] Simple Join: Thread 1 finished running" << std::endl;
}
...
void test_thread2(uintptr_t){
    ...
    std::cout << "[Uniprocessor] Simple Join: Thread 2 finished running" << std::endl;
}

void test_func(uintptr_t){
    std::cout << "[Uniprocessor] Simple Join: Running test with 2 threads" << std::endl;
