...
void test_reader_writer(uintptr_t) {
    printf("[Multiprocessor] Fantasy Football: Running test with 10 stats people and 30 managers.\n");
    ...
    printf("[Multiprocessor] Fantasy Football: Test completed.\n");
}

int main() {
    cpu::boot(5, test_reader_writer, 0, 0, 0, 0);
}
