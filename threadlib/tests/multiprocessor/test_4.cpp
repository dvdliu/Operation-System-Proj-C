// Thread must acquire multiple shared resources. Deadlocks can occur.
...
{
    std::cout << "[Multiprocessor] Running bake off test with 5 threads and 3 shared resources." << std::endl;
    ...
    std::cout << "[Multiprocessor] Bake off test completed." << std::endl;
}

int main()
{
    cpu::boot(3, test_bake_off, 0, 0, 0, 0);
    return 0;
}
