...
public:
    ...
    // Newly added members and functions

    std::weak_ptr<thread_info>   info;  // Thread context

    /*
     * Helper function that runs a given function, and swaps to the next ready
     * thread after the function is finished
     */
    static void func_with_swap(thread_startfunc_t func, uintptr_t arg);
};