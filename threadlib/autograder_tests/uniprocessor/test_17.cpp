...
void test_func3(uintptr_t) {
    ...
    printf("[Uniprocessor] Single Mutex: Thread 3 finished running\n");
}
...
void test_func2(uintptr_t) {
    ...
    printf("[Uniprocessor] Single Mutex: Thread 2 finished\n");
}

void test_func1(uintptr_t) {
    printf("[Uniprocessor] Single Mutex: Running test with 3 threads\n");
    ...
    printf("[Uniprocessor] Single Mutex: Thread 1 finished running\n");
}
