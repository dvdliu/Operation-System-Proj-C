...
{
    std::cout << "[Uniprocessor] Complex Vending Machine: Running test with 5 stockers and 5 customers.\n";
    ...
    std::cout << "[Uniprocessor] Complex Vending Machine: Test completed.\n";
}
