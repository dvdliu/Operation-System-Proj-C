...
const unsigned int VENDING_MACHINE_SIZE = 10;
unsigned int vending_machine = 0;
...
{
    std::cout << "[Multiprocessor] Running vending machine test with 2 stockers and 2 customers." << std::endl;
    thread t1(stocker, 1);
    thread t2(stocker, 2);
    ...
    std::cout << "[Multiprocessor] Vending machine test completed." << std::endl;
}

int main()
{
    cpu::boot(3, test_vending_machine, 0, 0, 0, 0);
    return 0;
}
