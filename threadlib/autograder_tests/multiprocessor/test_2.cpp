...
{
    std::cout << "[Multiprocessor] Running computer contention test with 100 threads and 10 shared resources." << std::endl;
    ...
    std::cout << "[Multiprocessor] Computer contention test completed." << std::endl;
}
